            ...
            <div class="card-body">
                <form action="{{route('items.update', $item->id)}}" method="POST" enctype="multipart/form-data" >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="title" name="title" type="text" class="form-control @error('title') is-invalid @enderror" value="{{$item->title}}" autocomplete="title">
                            @error('title')
                        ...
                        <div class="col-md-6">
                            <select name="category_id" id="category" class="form-control">
                                ...
                                @foreach (App\Models\Category::all() as $category)
                                    <option value="{{$category->id}}" {{$category->id == $item->category->id ? 'selected' : ''}}>
                                        {{$category->title}}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            <select name="child_id" id="child_id" class="form-control">
                                ...
                                @foreach (\App\Models\Child::all() as $child )
                                    <option value="{{$child->id}}"{{$child->id == $item->childCategory->id ? 'selected' : ''}}>
                                        {{$child->title}}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="made_year" name="made_year" type="number" class="form-control @error('made_year') is-invalid @enderror" value="{{$item->made_year}}" autocomplete="made_year">
                            @error('made_year')
                                <span class="invalid-feedback" role="alert">
                                    {{$message}}
                                </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="number_of_copies" name="number_of_copies" type="number" class="form-control @error('number_of_copies') is-invalid @enderror" value="{{$item->number_of_copies}}" autocomplete="number_of_capies">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="number"id="price" name="price" class="form-control @error('price') is-invalid @enderror" value="{{$item->price}}" autocomplete="price">
                            @error('price')
                                <span class="invalid-feedback" role="alert">
                                    {{$message}}
                                </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="discount" name="discount" type="number" class="form-control @error('discount') is-invalid @enderror" value="{{$item->discount}}" autocomplete="discount">
                            @error('discount')
                                <span class="invalid-feedback" role="alert">
                                    {{$message}}
                                </span>
